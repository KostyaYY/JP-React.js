...
export function About() {
  ...
  return (
    <>
      <SEO 
        title={language === 'ukr' ? 'Про нас - JUSTYFIN PARTNERS' : 'About Us - JUSTYFIN PARTNERS'}
        description={language === 'ukr' 
          ? 'Ми — сучасна юридична фірма, що надає комплексні правові рішення для підприємців, інвесторів і компаній різних галузей.'
          : 'We are a modern law firm delivering comprehensive legal solutions for entrepreneurs, investors, and businesses across industries.'
        }
      />
          ...
          <div className={styles.advantagesContainer}>
            ...
            <div className={styles.advantagesGrid}>
              {advantages.map((advantage, index) => (
                <div
                  key={index}
                  className={`${styles.advantageCard} ${styles.fadeInUp}`}
